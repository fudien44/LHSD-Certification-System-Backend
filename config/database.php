    ...
    */
    ...
    'connections' => [
        ...
        'zkdb' => [
            ...
            'database' => env('DB_DATABASE_ZK', 'laravel'),
        ...
        'old_database' => [
            'driver' => 'sqlsrv',
            'url' => env('DB_URL'),
            'host' => env('OLDDTR_HOST', '127.0.0.1'),
            'port' => env('OLDDTR_PORT', '3306'),
            'database' => env('OLDDTR_DATABASE', 'laravel'),
            'username' => env('OLDDTR_USERNAME', 'root'),
            'password' => env('OLDDTR_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',

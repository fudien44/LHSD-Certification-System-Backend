...
<table width="100%"  cellspacing="0" class="table" style="table-layout:fixed;">
    ...
    <tbody>
        ...
        @endif
        @foreach($emp->cs_eligible->skip(7) as $cs)
        <tr>
...
<table width="100%"  cellspacing="0" class="table" style="table-layout:auto;">
	...
	<tbody>
		@foreach($emp->workex->skip(28) as $we)
		<tr>
...
<table width="100%"  cellspacing="0" class="table" style="table-layout:fixed;">
	...
	<tbody>
		...
		@endif
		@foreach($emp->volwork->skip(7) as $vw)
		<tr>
	...
	<tfoot>
        ...
        <tr>
			...
			<td colspan="1" style="padding: 10px;font-size: 10px; font-weight: bold; text-align:center;">{{date('m/d/Y', strtotime(now()))}}</td>
        </tr>
    </tfoot>
</table>
<div style="page-break-after: always;"></div>
...
<table width="100%"  cellspacing="0" class="table" style="table-layout:fixed;">
	...
	<tbody>
	@foreach($emp->trainatt->skip(22) as $ta)
    <tr>
...
<table width="100%"  cellspacing="0" class="table" style="table-layout:fixed;">
    ...
    <tbody>
        @foreach($emp->skills->skip(7) as $sk)
        <tr>
    ...
    <tfoot>
        <tr>
            <td colspan="3" class="fs" style="text-align: center; font-weight: bold; background-color: #EAEAEA; color: red;">
                *** End of LEARNING AND DEVELOPMENT (L&D) INTERVENTIONS/TRAINING PROGRAMS ATTENDED ***
            </td>
        </tr>
		<tr>
			...
			<td colspan="" style="padding: 10px;font-size: 10px; font-weight: bold; text-align:center;">{{date('m/d/Y', strtotime(now()))}}</td>
        </tr>
    </tfoot>
</table>
@endif
